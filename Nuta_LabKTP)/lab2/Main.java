...
class Main {
    public static void main(String[] args) {
        // Создание точек 2d
        Point2d myFirstTochka = new Point2d ();//создает точку (0,0)
        Point2d mySecondTochka = new Point2d (5,3);//создает точку (5,3)
        Point2d aThirdTachka = new Point2d (0,0);

        System.out.println("Точка myFirstTochka " + myFirstTochka.getX() + " "+ myFirstTochka.getY());
        System.out.println("Точка mySecondTochka " + mySecondTochka.getX()+ " "+ mySecondTochka.getY());
        System.out.println("Точка aThirdTachka " +  aThirdTachka.getX()+ " "+ aThirdTachka.getY());
        System.out.println("Сравнение 2 2d точек, значение: " + Point2d.comparePoints(mySecondTochka, aThirdTachka));
